                ...
                <div class="register-form">
                    ...
                    <form action="register" method="post" enctype="multipart/form-data" id="logform">
                        ...
                        <div class="group-input">
                            ...
                            <input type="password" id="pass" name="password" maxlength="16" required>
                        </div>
                        <div class="group-input">
                        ...
                        <button type="submit" class="site-btn register-btn" name="registers">REGISTER</button>
                    </form>
...
if (isset($_POST['registers'])) {
   ...
   // Debugging output
    ...
    if ($run_insert) {
        ...
        echo "<script>alert('Customer not inserted. Error: " . mysqli_error($con) . "')</script>";
    }
}
?>
