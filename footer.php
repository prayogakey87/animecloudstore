            ...
            <div class="col-lg-3">
                <div class="footer-left">
                    <div class="footer-logo">
                        <a href="index.php"> <span>Animecloudstore</span>
                        </a>
                    </div>
                    <ul>
                        <li>+62 85161795960</li>
                        <li>animecloudstore.com</li>
                        <li>Jalan Imam Bonjol</li>
                    </ul>
            ...
            <div class="col-lg-2 offset-lg-1">
                <div class="footer-widget">
                    ...
                    <ul>
                        ...
                        <li><a href="syarat.php">Terms & Condition</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2">
